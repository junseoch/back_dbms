...
CREATE TABLE TBL_COMPANY(
	...
	COMPANY_PHONE NUMBER UNIQUE NOT NULL,
...
CREATE TABLE TBL_APPLY(
	ID NUMBER CONSTRAINT PK_APLLY PRIMARY KEY,
	APPLY_NAME VARCHAR2(255),
	AD_ID NUMBER,
	COMPANY_ID NUMBER,
	BIG_ID NUMBER,
	CONSTRAINT FK_APPLY_AD FOREIGN KEY 
);
...
CREATE TABLE TBL_SMALL(
	...
	SMALL_NAME VARCHAR2(255),
	MID_ID NUMBER, -- 중카테고리 FK
	CONSTRAINT FK_SMALL_MID FOREIGN KEY(MID_ID)
